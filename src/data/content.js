/**
 * Site content. Replace project names/photos/reviews with your real ones —
 * the structure stays identical.  ⚠️ = placeholder content.
 */
...
export const projects = [
  {
    ...
    summary: 'A restrained palette of oak veneer, lime plaster and brushed brass for a family relocating from Bengaluru.',
  },
  {
    ...
    summary: 'Storage-first planning for a young couple — 14 running feet of concealed storage without visual bulk.',
  },
  {
    ...
    summary: 'A full gut-renovation of a 1990s builder floor: new services, moulded panelling and Italian marble.',
  },
  {
  ...
  },
  {
    ...
    summary: 'Every wall does two jobs — a fold-down study, bed storage, and a wardrobe that hides the meter box.',
  },
  {
  ...
  },
  {
    ...
    summary: 'Light oak, off-white and a strict no-clutter brief — Japandi executed without the cliché.',
  },
];
...
export const faqsGeneral = [
  ...
  },
  {
    ...
    a: '<p>Yes, and a big share of our renovation work is on occupied homes. We phase the work room by room, dust-seal the active zone daily, and work within your society\'s permitted hours. For rentals, we focus on non-permanent, removable interventions — modular units that you can take with you.</p>',
  },
];
...
export const posts = [
  {
    slug: 'interior-design-cost-delhi-ncr',
    title: 'Interior Design Cost in Delhi NCR: The Honest 2026 Breakdown',
    excerpt: 'Real per-square-foot rates for Gurugram, Noida and Delhi — what drives cost up, where you can safely save, and the five line items most quotes hide.',
    category: 'Cost Guides', date: '2026-06-18', readTime: '11 min',
    image: '/assets/img/blog/b1.jpg',
    alt: 'Designer reviewing an itemised interior BOQ with material samples on a desk',
    featured: true,
  },
  {
    slug: 'modular-kitchen-materials-guide',
    title: 'BWP vs BWR vs MR Plywood: What Your Kitchen Actually Needs',
    metaTitle: 'BWP vs BWR vs MR Plywood for Kitchens | Nexora',
    excerpt: 'A no-jargon guide to plywood grades, shutter finishes and hardware brands — so you can read a BOQ and know instantly whether you are being overcharged.',
    category: 'Materials', date: '2026-05-30', readTime: '9 min',
    image: '/assets/img/blog/b2.jpg',
    alt: 'Close-up of plywood edge samples and kitchen shutter finish swatches',
  },
  {
    slug: '2-bhk-interior-checklist',
    title: 'The 2 BHK Interior Checklist Every NCR Buyer Should Print',
    metaTitle: '2 BHK Interior Checklist for NCR Buyers | Nexora',
    excerpt: '42 decisions to make before you sign — sequenced in the order they actually come up, with the ones that are expensive to change later flagged in red.',
    category: 'Planning', date: '2026-05-12', readTime: '8 min',
    image: '/assets/img/blog/b3.jpg',
    alt: 'Floor plan drawings and a checklist on a table with fabric swatches',
  },
  {
    slug: 'small-apartment-storage-ideas',
    title: '17 Storage Ideas That Actually Work in Sub-900 sq.ft Homes',
    metaTitle: '17 Storage Ideas for Small Homes Under 900 sq.ft',
    excerpt: 'Tested in real Dwarka and Noida flats — the storage interventions that pay for themselves, and the Pinterest ideas that fail in Indian homes.',
    category: 'Design Ideas', date: '2026-04-26', readTime: '7 min',
    image: '/assets/img/blog/b4.jpg',
    alt: 'Compact bedroom with full-height wardrobe and integrated study nook',
  },
  {
    slug: 'vastu-modern-interiors',
    title: 'Vastu and Modern Interiors: Making Both Work Without Compromise',
    excerpt: 'How we reconcile Vastu with contemporary layouts — the rules worth honouring, the ones with practical workarounds, and how to discuss them.',
    category: 'Planning', date: '2026-04-08', readTime: '10 min',
    image: '/assets/img/blog/b5.jpg',
    alt: 'Architect marking directional orientation on an apartment floor plan',
  },
  {
...
export const processSteps = [
  { title: 'Consultation & site survey', text: 'A senior designer visits your home, measures every wall, and understands how your family actually lives. No sales script.', time: 'Day 1–3' },
  { title: 'Concept & 3D design', text: 'Mood boards, layout options and photoreal 3D views of every room. You see the home before a single sheet is cut.', time: 'Day 4–10' },
  { title: 'Itemised BOQ & contract', text: 'Line-by-line costing with brand names and specifications. Fixed price, signed scope, clear payment milestones.', time: 'Day 11–14' },
  { title: 'Production in our factory', text: 'Modular units are CNC-cut, edge-banded and finished in a controlled environment — not assembled with dust on your floor.', time: 'Day 15–32' },
  { title: 'Site execution', text: 'Civil, electrical, ceiling and painting run in a sequenced plan. Daily site supervision, weekly photo reports on WhatsApp.', time: 'Day 20–40' },
  { title: 'Installation & styling', text: 'Modular units go in, lighting is commissioned, and our stylist dresses the home for your first walk-through.', time: 'Day 41–45' },
...
export const designStyles = [
  { name: 'Warm Minimal', desc: 'Clean lines softened with oak, linen and lime plaster. The most-requested look in NCR right now.', icon: 'leaf' },
  { name: 'Modern Classic', desc: 'Panelled walls, cornices and marble — traditional proportions with contemporary restraint.', icon: 'gem' },
  { name: 'Japandi', desc: 'Japanese discipline meets Scandinavian warmth. Low furniture, light woods, zero clutter.', icon: 'compass' },
  { name: 'Contemporary Indian', desc: 'Jaali screens, brass inlay and handloom textiles set against a modern shell.', icon: 'sparkles' },
  { name: 'Industrial Loft', desc: 'Exposed services, micro-cement and blackened steel — best in duplexes and studios.', icon: 'layers' },
  { name: 'Luxe Contemporary', desc: 'Book-matched stone, fluted glass and layered lighting for penthouses and villas.', icon: 'trophy' },
];
